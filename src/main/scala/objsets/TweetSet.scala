...
object GoogleVsApple:
  ...
  lazy val googleTweets: TweetSet = allTweets.filter(twt => google.exists(w => twt.text.contains(w)))
  lazy val appleTweets: TweetSet = allTweets.filter(twt => apple.exists(w => twt.text.contains(w)))
